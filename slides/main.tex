...
\begin{frame}{MCTS applied to CartPole-v1}
    \centering
    \href{https://www.youtube.com/watch?v=LtIqCVRqRTw}{
        \includegraphics[width=0.5\textwidth]{images/cart_pole_mcts.png}
    }
    \vfill
    \small \textit{Click image to watch on YouTube}
\end{frame}
...
\begin{frame}{CEM applied to CartPole-v1}
    \centering
    \href{https://www.youtube.com/watch?v=N8gq00_RGWk}{
        \includegraphics[width=0.5\textwidth]{images/cart_pole_cem.png}
    }
    \vfill
    \small \textit{Click image to watch on YouTube}
\end{frame}
...
\begin{frame}{CEM applied to CarRacing-v3}
    \centering
    \href{https://www.youtube.com/watch?v=0bJDuGY-rt8}{
        \includegraphics[width=0.5\textwidth]{images/car_racing_cem.png}
    }
    \vfill
    \small \textit{Click image to watch on YouTube}
\end{frame}
